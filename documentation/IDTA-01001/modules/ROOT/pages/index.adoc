...
This is version 3.3 of the specification IDTA-01001.
...
* defines format for interoperable file exchange of Asset Administration Shells 
|===
...
For a detailled changelog look into the xref:changelog.adoc[Change Notes].

Version 3.2 was produced by the Work Stream "Specification of the Asset Administration Shell" of the Working Group "Open Technology" of the link:https://industrialdigitaltwin.org/[Industrial Digital Twin Association (IDTA)], published in July 2026.

Version 3.1 was produced by the Work Stream "Specification of the Asset Administration Shell" of the Working Group "Open Technology" of the link:https://industrialdigitaltwin.org/[Industrial Digital Twin Association (IDTA)], published in May 2025.
...
It is the first release published by the link:https://industrialdigitaltwin.org/[Industrial Digital Twin Association (IDTA)].
