...
This is version 3.2 of the specification IDTA-01001.
...
* IDTA-01003-a Part 3a: Data Specification – IEC 61360 in version **3.X** xref:bibliography.adoc#bib46[[46\]]
...
IDTA Document Number: IDTA-01001-3-2
...
This document (version 3.2) is produced by the Work Stream "Specification of the Asset Administration Shell" of the Working Group "Open Technology" of the https://industrialdigitaltwin.org/[Industrial Digital Twin Association (IDTA)].

This document (version 3.1) was finalized in May 2025 by the Work Stream "Specification of the Asset Administration Shell" of the Working Group "Open Technology" of the https://industrialdigitaltwin.org/[Industrial Digital Twin Association (IDTA)].
