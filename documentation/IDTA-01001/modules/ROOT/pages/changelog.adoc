...
* description of data type ContentType changed, some explanations with respect to mime types were removed (https://github.com/admin-shell-io/aas-specs-metamodel/issues/604[#604])
...
* Added xref:spec-metamodel/core.adoc#AssetInformation[AssetInformation]/AssetType to annex table "Elements with Allowed Identifying Values"


=== Metamodel Changes V3.2 vs. V3.1

.Changes in Metamodel
[cols="5%,42%,48%",options="header",]
|===
|*Nc* |*V3.2 Change w.r.t. V3.1.1* |*Comment*
...
[cols="5%,42%,48%",options="header",]
|===
h|Nc h|V3.2 Change w.r.t. V3.1 h|Comment
...
|===
h|{empty} h|New Elements V3.2 vs V3.1 h|Comment
{empty} | AdministrativeInformation/createdAt | a| TO BE CLARIFIED
{empty} | AdministrativeInformation/updatedAt | a| TO BE CLARIFIED
|===
...
[cols="5%,41%,51%",options="header",]
|===
|{empty} |*New Elements V3.1 vs V3.0.2* |*Comment*
