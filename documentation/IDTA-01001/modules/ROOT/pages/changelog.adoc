...
* description of data type ContentType changed, some explanation with respect to mime types removed (https://github.com/admin-shell-io/aas-specs-metamodel/issues/604[#604])
