...
* CHANGED: description of data type ContentType changed, some explanations with respect to mime types were removed (https://github.com/admin-shell-io/aas-specs-metamodel/issues/604[#604])
* CHANGED: rename submodel to Submodel and submodel element to SubmodelElement to be conformant to IEC 63278-1 and terms and definitions, this also leads to reformulation of some constraints
* ADDED: Annex UML - add information how to graphically depict attributes of type "Reference" (https://github.com/admin-shell-io/aas-specs-metamodel/issues/601[#601])
* CHANGED: definition of term "capability" (https://github.com/admin-shell-io/aas-specs-metamodel/issues/649[#649])
...
|===
h|Nc h|V3.2 vs. V3.1 h|New, Update, Removed, Reformulated h|Comment
| | | a| 
|===
...
[cols="5%,10%,15%,69%",options="header",]
|===
h|Nc h|V3.1 vs. V3.0 h|New, Update, Removed, Reformulated h|Comment

|{empty}  |AASd-108 |Update a|
use "SubmodelElement" instead of "submodel element"

|{empty}  |AASd-128 |Update a|
use "SubmodelElement" instead of "submodel element" 

|{empty}  |AASd-129 |Update a|
use "SubmodelElement" instead of "submodel element" and "Submodel" instead of "submodel"
...
[cols="5%,42%,48%",options="header",]
|===
h| Nc h| V3.1 Change w.r.t. V3.0.2 h| Comment
...
* ADDED: New value "Role" to enumeration AssetKind (https://github.com/admin-shell-io/aas-specs-metamodel/issues/294[#294])
* ADDED: New logical enumerations "AasContainerSubmodelElements" and "AasNonContainerSubmodelElements"  (https://github.com/admin-shell-io/aas-specs-metamodel/issues/420[#420])
* CHANGED: Data type Identifier: change length from 2000 to 2048 characters (https://github.com/admin-shell-io/aas-specs-metamodel/issues/306[#306])
* CHANGED: Data type ContentType: change length from 100 to 128 characters
* CHANGED: Referable/idShort and Constraint AASd-002: now also allows hyphens to be included in name (https://github.com/admin-shell-io/aas-specs-metamodel/issues/295[#295])
* CHANGED: Entity/entityType and Constraint AASd-014: entityType now optional (https://github.com/admin-shell-io/aas-specs-metamodel/issues/287[#287])
* CHANGED: Change RelationshipElement: attributes "first" and "second" now optional (conformant to "min" and "max" of "Range")(https://github.com/admin-shell-io/aas-specs-metamodel/issues/412[#412]), AnnotatedRelationshipElement inherits from RelationshipElement and is thus also affected.
* CHANGED: Change File and Blob: attribute "contentType" now optional (https://github.com/admin-shell-io/aas-specs-metamodel/issues/412[#412])
* CHANGED: Value-Only Schema adapted to changes in classes Entity, RelationshipElement etc.
* REMOVED: remove AASd-120: idShort also allowed for elements within a SubmodelElementList (https://github.com/admin-shell-io/aas-specs-metamodel/issues/432[#432])
* REMOVED: remove AASd-090: category is deprecated (https://github.com/admin-shell-io/aas-specs-metamodel/issues/514[#514])
* CHANGED: Relaxation of grammar for semantic IDs for metamodel elements in the context of data specifications
(https://github.com/admin-shell-io/aas-specs-metamodel/issues/307[#307])
* CHANGED: Terms and Definitions adopted to IEC 63278-1:2023 (before IEC 63278-1 Draft July 2022 was the basis), 
(https://github.com/admin-shell-io/aas-specs-metamodel/issues/365[#365])
...
(https://github.com/admin-shell-io/aas-specs-metamodel/issues/350[#350], 
https://github.com/admin-shell-io/aas-specs-metamodel/issues/471[#471],
 https://github.com/admin-shell-io/aas-specs-metamodel/issues/473[#473],
 https://github.com/admin-shell-io/aas-specs-metamodel/issues/479[#479],
 https://github.com/admin-shell-io/aas-specs-metamodel/issues/347[#347])
* ADDED:(Editorial) Adding metamodel element IDs to tables themselves for easier usage (besides grammar defining how to derive them) (https://github.com/admin-shell-io/aas-specs-metamodel/issues/366[#366])
* CHANGED: Update all metamodel element IDs to V3.1 (https://github.com/admin-shell-io/aas-specs-metamodel/issues/366[#366])
* CHANGED: Transfer of clauses on formats Metadata, Paths and Value-Only from Part 2 API to Part 1 Metamodel (https://github.com/admin-shell-io/aas-specs-metamodel/issues/325[#325])
* CHANGED: (Editorial) Update clause on Value-Only Serialization, improve documentation (https://github.com/admin-shell-io/aas-specs-metamodel/issues/370[#370], https://github.com/admin-shell-io/aas-specs-metamodel/issues/371[#371], https://github.com/admin-shell-io/aas-specs-metamodel/issues/411[#411])
** ADDED: add table similar to metadata table: which attributes are displayed in Value-Only serialization
** CHANGED: update examples to provide Value-Only serialization for every SubmodelElement (not in the context of a Submodel as before)
...
* CHANGED: Transfer from .docx to asciidoc (.adoc) and maintenance in GitHub (including (https://github.com/admin-shell-io/aas-specs-metamodel/issues/318[#318], https://github.com/admin-shell-io/aas-specs-metamodel/issues/316[#316] )
* CHANGED: Transfer of all UML figures to PlantUML (.puml), changed notation for model references; maintenance in GitHub, no XMI presenation part of release any longer (https://github.com/admin-shell-io/aas-specs-metamodel/issues/439[#439]) 

Bugfixes:

* CHANGED: add missing `<referredSemanticId>` to grammar for textual representation of References https://github.com/admin-shell-io/aas-specs/issues/557[#557])
...
* REMOVED: remove information on AutomationML mapping (https://github.com/admin-shell-io/aas-specs-metamodel/issues/397[#397])
...
* CHANGED: consistent usage of idShortPath and IRDI-Path (https://github.com/admin-shell-io/aas-specs-metamodel/issues/385[#385])
...
* CHANGED: editorial changes (including https://github.com/admin-shell-io/aas-specs-metamodel/issues/345[#345], 
https://github.com/admin-shell-io/aas-specs-metamodel/issues/361[#361], 
https://github.com/admin-shell-io/aas-specs-metamodel/issues/385[#385])
...
| {empty} | xref:spec-metamodel/datatypes.adoc#Identifier[Identifier] a| data type: change length from 2000 to 2048 characters
...
|===
h|Nc h|New Elements V3.1 vs V3.0.2 h|Comment
...
* CHANGED: Replace xs:dateType with xs:dateTime (https://github.com/admin-shell-io/aas-specs-metamodel/issues/467[#467])

* CHANGED: Improve description of example for Reference (https://github.com/admin-shell-io/aas-specs-metamodel/issues/481[#481])

* CHANGED: UML Template description with respect to cardinality (https://github.com/admin-shell-io/aas-specs-metamodel/issues/388[#388])
...
[cols="5%,42%,48%",options="header",]
|===
h|Nc h| V3.0.2 Change w.r.t. V3.0.1 h| Comment
...
* CHANGED: DataTypeDefXsd all links now reference correctly to XML Schema 1.0 (xmlschema-2) not to XML Schema V1.1 (xmlschema11-2) (https://github.com/admin-shell-io/aas-specs-metamodel/issues/312[#312], https://github.com/admin-shell-io/aas-specs-metamodel/issues/363[#363]), i.e. remove xs:yearMonthDuration + editorial changes (remove redundant entries, sort entries.
Additionally, added notes that RDF is using XML Schema 1.1 but a subset.

* CHANGED: support relative path for SubmodelElement File, PathType: support complete URI scheme for files RFC2396 conformant to anyURI of XML Schema 1.0, Part 2 (https://github.com/admin-shell-io/aas-specs-metamodel/issues/299[#299])

* CHANGED: Constraint AASd-116 globalAssetId + added note that globalAssetId should only be used in discovery functionality but not as value for SpecificAssetId/name (https://github.com/admin-shell-io/aas-specs-metamodel/issues/390[#390])

* CHANGED: make EmbeddedDataSpecification/dataSpecification mandatory (as implemented in schemas) (https://github.com/admin-shell-io/aas-specs-metamodel/issues/296[#296])

* CHANGED: Update on handling AASd-130 for schemas different to xml and reformulation of Constraint AASd-130 (https://github.com/admin-shell-io/aas-specs-metamodel/issues/362[#362])

* CHANGED: (Editorial): updated Change Logs of V3.0 w.r.t. Range: Range was set to experimental in V3.0


* CHANGED: (Editorial, the schemas implemented it like this) Annex UML Tables: "0..*" or "0..3" etc. means that the list may be either not available (optional) or the list is not empty. (https://github.com/admin-shell-io/aas-specs-metamodel/issues/418[#418])

* CHANGED: (Editorial, the schemas implemented it like this, table was correct) Update Figure containing Resource: Resource/path has cardinality 1 and Resource/contentType has cardinality 0..1 (https://github.com/admin-shell-io/aas-specs-metamodel/issues/438[#438])
...
* (Editorial) MultiLanguageNameType inconsistent description, maxLength=128 (schemata were correct) (https://github.com/admin-shell-io/aas-specs-metamodel/issues/313[#313])
* (Editorial) HasKind/kind explanatory text: use template, not type (https://github.com/admin-shell-io/aas-specs-metamodel/issues/313[#313])
...
* (Editorial) fix figure "Association" in Annex for UML (https://github.com/admin-shell-io/aas-specs-metamodel/issues/328[#328])
...
[cols="5%,42%,48%",options="header",]
|===
h| Nc h| V3.1 Change w.r.t. V3.0 h| Comment
...
[cols="5%,10%,15%,69%",options="header",]
|===
h| Nc h| V3.0 vs. V2.0.1 h| New, Update, Removed, Reformulated h| Comment
...
[cols="5%,42%,48%",options="header",]
|===
h| Nc h| V3.0 Change w.r.t. V2.0.1 h| Comment
...
[cols="5%,41%,51%",options="header",]
|===
h|Nc  h|New Elements V3.0 vs V2.0.1 h|Comment
...
+
New \<<Experimental>> SubmodelElement for events
...
+
New SubmodelElement SubmodelElementList added, renamed Submodel elements Event and BasicEvent to EventElement and BasicEventElement
...
| |AASd-008 |Removed |Constraint AASd-008: The SubmodelElement value of an operation variable shall be of kind=Template.
| |AASd-010 |Renamed a|
...
| |AASd-129 |Reformulated |Constraint AASd-129: If any Qualifier/kind value of a SubmodelElement/qualifier (attribute qualifier inherited via Qualifiable) is equal to TemplateQualifier, the SubmodelElement shall be part of a Submodel template, i.e. a Submodel with Submodel/kind (attribute kind inherited via HasKind) value equal to Template.
...
| |AASd-108 |New |Constraint AASd-108: All first level child elements in a SubmodelElementList shall have the same SubmodelElement type as specified in SubmodelElementList/typeValueListElement.
...
| |AAS-128 |New |Constraint AASd-128: For model references, i.e. References with Reference/type = ModelReference, the Key/value of a Key preceded by a Key with Key/type=SubmodelElementList is an integer number denoting the position in the array of the SubmodelElement list.
| |AASd-129 |New a|
Necessary as supplement for AASd-119 since SubmodelElement does not inherit from HasKind any longer

Constraint AASd-129: If any Qualifier/kind value of a SubmodelElement/qualifier (attribute qualifier inherited via Qualifiable) is equal to TemplateQualifier, the SubmodelElement shall be part of a Submodel template, i.e. a Submodel with Submodel/kind (attribute kind inherited via HasKind) value equal to Template.
...
* CHANGED: Updated text for SubmodelElement collections
...
|===
h| Nc h| V3.0 Change w.r.t. V3.0RC02 h| Comment
...
|===
h|Nc h|V3.0 vs. V3.0RC02 New Elements h|Comment
...
|===
h| Nc h| V3.0 vs. V3.0RC02 h| New, Update, Removed, Reformulated h| Comment
| | |EDITORIAL a|
...
Constraint AASd-129: If any Qualifier/kind value of a SubmodelElement/qualifier (attribute qualifier inherited via Qualifiable) is equal to TemplateQualifier, the SubmodelElement shall be part of a Submodel template, i.e. a Submodel with Submodel/kind (attribute kind inherited via HasKind) value to Template.
...
|===
h| Nc h| V3.0RC02 Change w.r.t. V2.0.1 h| Comment
...
|===
h|Nc h|V3.0RC02 vs. V2.0.1 New Elements h|Comment
...
New SubmodelElement SubmodelElementList added, Submodel elements Event and BasicEvent to EventElement and BasicEventElement renamed
...
|===
h| Nc h| V3.0RC02 vs. V2.0.1 h| New, Update, Removed, Reformulated h| Comment
| |AASd-001 |Removed a|
...
| |AASd-120 |New a|
For new SubmodelElement SubmodelElementList
...
| |AA-128 |New |Constraint AASd-128: For model references, i.e. References with Reference/type = ModelReference, the Key/value of a Key preceded by a Key with Key/type=SubmodelElementList is an integer number denoting the position in the array of the SubmodelElement list.
|===
...
|===
h| Nc h| V3.0RC02 vs. V2.0.1 h| Comment
| |DataSpecification/administration |Was inherited before by Identifiable
| |DataSpecification/id |Was inherited before by Identifiable
| |DataSpecification/description |Was inherited before by Identifiable
...
|===
h| Nc h| V3.0RC02 Change w.r.t. V3.0RC01 h| Comment
| |xref:spec-metamodel/common.adoc#AdministrativeInformation[AdministrativeInformation] |Bugfix: Stereotype "DataType" added
...
[cols="5%,45%,51%",options="header",]
|===
h|Nc h|V3.0RC02 vs. V2.0RC01 New Elements h|Comment
| |AasSubmodelElements a|
New enumeration used for References
...
|===
h| Nc h| V3.0RC02 vs. V3.0RC01 h| New, Update, Removed, Reformulated h| Comment
|footnote:[Every model valid for V3.0RC02 is still valid in V3.0RC01, however there might be implementations that need to be changed if they assumed that the user can type case-insensitive names and get all elements that match the name in a case-insensitive way.] |AASd-003 |Update a|
idShort is case-sensitive and not case-insensitive
...
Constraint AASd-053: If the semanticId of a Range SubmodelElement references a ConceptDescription then the ConceptDescription/category shall be one of following values: PROPERTY.

| |AASd-054 |Removed a|
removed, still recommended; would be renamed to AASc if still needed

Constraint AASd-054: If the semanticId of a ReferenceElement SubmodelElement references a ConceptDescription then the ConceptDescription/category shall be one of following values: REFERENCE.

| |AASd-055 |Removed a|
removed, still recommended; would be renamed to AASc if still needed

Constraint AASd-055: If the semanticId of a RelationshipElement or an AnnotatedRelationshipElement SubmodelElement references a ConceptDescription then the ConceptDescription/category shall be one of following values: RELATIONSHIP.

| |AASd-056 |Removed a|
removed, still recommended; would be renamed to AASc if still needed

Constraint AASd-056: If the semanticId of an Entity SubmodelElement references a ConceptDescription then the ConceptDescription/category shall be one of following values: ENTITY. The ConceptDescription describes the elements assigned to the entity via Entity/statement.

| |AASd-057 |Removed a|
removed, still recommended; would be renamed to AASc if still needed

Constraint AASd-057: The semanticId of a File or Blob SubmodelElement shall only reference a ConceptDescription with the category DOCUMENT.

| |AASd-058 |Removed a|
removed, still recommended; would be renamed to AASc if still needed

Constraint AASd-058: The semanticId of a Capability SubmodelElement shall only reference a ConceptDescription with the category CAPABILITY.
...
Constraint AASd-060: If the semanticId of an Operation SubmodelElement references a ConceptDescription then the category of the ConceptDescription shall be one of the following values: FUNCTION.

| |AASd-061 |Removed a|
removed, still recommended; would be renamed to AASc if still needed

Constraint AASd-061: If the semanticId of an Event SubmodelElement references a ConceptDescription then the category of the ConceptDescription shall be one of the following values: EVENT.
...
Constraint AASd-068: If the semanticId of a Range SubmodelElement references a ConceptDescription then DataSpecificationIEC61360/dataType shall be a numerical one, i.e. REAL_* or RATIONAL_*.
...
[cols="5%,14%,14%,63%",options="header",]
|===
h| Nc h| V3.0RC02 h| New, Update, Removed, Reformulated h| Comment
| |AASc-002 |New a|
Updated version of AASd-076, renamed to AASC-002 because applicable to data specification IEC61360
...
[cols="5%,44%,45%",options="header",]
|===
h| Nc h| V3.0RC02 vs. V3.0RC01 h| Comment
| |AccessPermissionRule/constraint |Substitute for inherited attributes from Qualifiable
|===
...
|===
h| Nc h| V3.0RC01 Change w.r.t. V2.0.1 h| Comment
...
[cols="5%,46%,43%",options="header",]
|===
h| Nc h| V3.0RC01 vs. V2.0.1 h| Comment
|x |AssetAdministrationShell/assetInformation |Substitute for AssetAdministrationShell/asset (no reference any longer, instead aggregation)
...
|===
h| Nc h| V3.0RC01 h| New, Update, Removed, Reformulated h| Comment
| |AASd-001 |Removed a|
Constraint AASd-001: In case of a referable element not being an identifiable element this id is mandatory and used for referring to the element in its name space.
...
|(x) |AASd-053 |New |Constraint AASd-053: If the semanticId of a Range SubmodelElement references a ConceptDescription then the ConceptDescription/category shall be one of following values: PROPERTY.
|(x) |AASd-054 |New |Constraint AASd-054: If the semanticId of a ReferenceElement SubmodelElement references a ConceptDescription then the ConceptDescription/category shall be one of following values: REFERENCE.
|(x) |AASd-055 |New |Constraint AASd-055: If the semanticId of a RelationshipElement or an AnnotatedRelationshipElement SubmodelElement references a ConceptDescription then the ConceptDescription/category shall be one of following values: RELATIONSHIP.
|(x) |AASd-056 |New |Constraint AASd-056: If the semanticId of an Entity SubmodelElement references a ConceptDescription then the ConceptDescription/category shall be one of following values: ENTITY. The ConceptDescription describes the elements assigned to the entity via Entity/statement.
|(x) |AASd-057 |New |Constraint AASd-057: The semanticId of a File or Blob SubmodelElement shall only reference a ConceptDescription with the category DOCUMENT.
|(x) |AASd-058 |New |Constraint AASd-058: The semanticId of a Capability SubmodelElement shall only reference a ConceptDescription with the category CAPABILITY.
|(x) |AASd-059 |New |Constraint AASd-059: The semanticId of a SubmodelElementCollection SubmodelElement shall only reference a ConceptDescription with the category COLLECTION or ENTITY.
|(x) |AASd-060 |New |Constraint AASd-060: If the semanticId of an Operation SubmodelElement references a ConceptDescription then the category of the ConceptDescription shall be one of the following values: FUNCTION.
|(x) |AASd-061 |New |Constraint AASd-061: If the semanticId of an Event SubmodelElement references a ConceptDescription then the category of the ConceptDescription shall be one of the following values: EVENT.
...
|(x) |AASd-068 |New |Constraint AASd-068: If the semanticId of a Range SubmodelElement references a ConceptDescription then DataSpecificationIEC61360/dataType shall be a numerical one, i.e. REAL_* or RATIONAL_*.
...
[cols="5%,44%,45%",options="header",]
|===
h| Nc h| V2.0.1 Change w.r.t. V2.0 h| Comment
...
|===
h| Nc h| V2.0.1 h| New, Update, Removed h| Comment
| |AASd-001 |update a|
...
* Composite I4.0 Components supported via new Entity SubmodelElement and billOfMaterial
* Event SubmodelElement introduced
* Capability SubmodelElement introduced
* Annotatable relationship SubmodelElement introduced
* MultiLanguageProperty SubmodelElement introduced
* Range SubmodelElement introduced
...
[cols="5%,44%,45%",options="header",]
|===
h| Nc h| V2.0 Change w.r.t. V1.0 h| Comment
...
|===
h| Nc h| V2.0 h| New, Update, Removed h| Comment
| |AASd-007 |update a|
Reformulated
...
Constraint AASd-008: The SubmodelElement value of an operation variable shall be of kind=Template.
