...
* Added xref:spec-metamodel/core.adoc#AssetInformation[AssetInformation/AssetType] to Annex "General Topics", table "Elements with Allowed Identifying Values"
