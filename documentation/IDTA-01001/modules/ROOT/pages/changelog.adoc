...
* CHANGED: editorial changes (including https://github.com/admin-shell-io/aas-specs-metamodel/issues/637[#637] and https://github.com/admin-shell-io/aas-specs-metamodel/issues/638[#638] )
