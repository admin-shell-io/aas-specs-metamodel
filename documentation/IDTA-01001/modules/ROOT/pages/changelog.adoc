...
* CHANGED: Annex "DPP", mapping from SingleValuesDataElement to Blob as a possible mapping removed

Minor Changes:

* Annex xref:annex/uml-templates.adoc[UML Template]: add new stereotype \<<Invalidated>>
* Annex DPP: improved documentation and consistency of examples
