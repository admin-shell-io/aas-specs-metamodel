...
////
= Overview of SubmodelElement Types
include::../includes/constraints.adoc[]

.Metamodel Overview for SubmodelElement Subtypes
...
SubmodelElements include data properties as well as operations, events and other elements needed to describe a model for an asset (see <<image-28-submodel-element-subtypes>>).

== General

All SubmodelElements including abstract classes like data elements are specified in alphabetical order.
...
h|ID: 3+| `\https://admin-shell.io/aas/3/2/AnnotatedRelationshipElement`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|[[AnnotatedRelationshipElement-annotations]] annotation 3+| `\https://admin-shell.io/aas/3/2/AnnotatedRelationshipElement/annotation`
...
h|ID: 3+| `\https://admin-shell.io/aas/3/2/BasicEventElement`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|[[BasicEventElement-observed]]observed 3+| `\https://admin-shell.io/aas/3/2/BasicEventElement`
...
.2+e|[[BasicEventElement-direction]]direction 3+| `\https://admin-shell.io/aas/3/2/BasicEventElement/direction`
a|
Direction of event
...
.2+e|[[BasicEventElement-state]]state 3+| `\https://admin-shell.io/aas/3/2/BasicEventElement/state`
a|
State of event
...
.2+e|[[BasicEventElement-messageTopic]]messageTopic 3+| `\https://admin-shell.io/aas/3/2/BasicEventElement/messageTopic`
...
.2+e|[[BasicEventElement-messageBroker]]messageBroker 3+| `\https://admin-shell.io/aas/3/2/BasicEventElement/messageBroker`
a|
...
.2+e|[[BasicEventElement-lastUpdate]]lastUpdate 3+| `\https://admin-shell.io/aas/3/2/BasicEventElement/lastUpdate`
...
.2+e|[[BasicEventElement-minInterval]]minInterval 3+| `\https://admin-shell.io/aas/3/2/BasicEventElement/minInterval`
a|
...
.2+e|[[BasicEventElement-maxInterval]]maxInterval 3+| `\https://admin-shell.io/aas/3/2/BasicEventElement/maxInterval`
a|
...
|Set of: |--
h|ID: | `\https://admin-shell.io/aas/3/2/Direction`

.2+h|Literal h| ID
h|Explanation

.2+e|[[Direction-input]]input | `\https://admin-shell.io/aas/3/2/Direction/input`
a|Input direction

.2+e|[[Direction-output]]output | `\https://admin-shell.io/aas/3/2/Direction/output`
a|Output direction
|===
...
|Set of: |--
h|ID: | `\https://admin-shell.io/aas/3/2/StateOfEvent`

.2+h|Literal h| ID
h|Explanation

.2+e|[[StateOfEvent-on]]on | `\https://admin-shell.io/aas/3/2/StateOfEvent/on`
a|Event is on

.2+e|[[StateOfEvent-off]]off | `\https://admin-shell.io/aas/3/2/StateOfEvent/off`
a|Event is off
|===
...
h|Inherits from: 3+|-
h|ID: 3+| `\https://admin-shell.io/aas/3/2/EventPayload`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|[[EventPayload-source]]source 3+| `\https://admin-shell.io/aas/3/2/EventPayload/source`
a|Reference to the source event element |ModelReference<xref:EventElement[EventElement]> |1

.2+e|[[EventPayload-sourceSemanticId]]sourceSemanticId 3+| `\https://admin-shell.io/aas/3/2/EventPayload/sourceSemanticId`
a|
...
.2+e|[[EventPayload-observableReference]]observableReference 3+| `\https://admin-shell.io/aas/3/2/EventPayload/observableReference`
...
.2+e|[[EventPayload-observableSemanticId]]observableSemanticId 3+| `\https://admin-shell.io/aas/3/2/EventPayload/observableSemanticId`
a|
...
.2+e|[[EventPayload-topic]]topic 3+| `\https://admin-shell.io/aas/3/2/EventPayload/topic`
a|Information for the outer message infrastructure to schedule the event for the respective communication channel |xref:spec-metamodel/datatypes.adoc#MessageTopicType[MessageTopicType] |0..1

.2+e|[[EventPayload-subjectId]]subjectId 3+| `\https://admin-shell.io/aas/3/2/EventPayload/subjectId`
a|
...
.2+e|[[EventPayload-timestamp]]timestamp 3+| `\https://admin-shell.io/aas/3/2/EventPayload/timestamp`
a|Timestamp in UTC, when this event was triggered |xref:spec-metamodel/datatypes.adoc#DateTimeUtc[DateTimeUtc] |1

.2+e|[[EventPayload-payload]]payload 3+| `\https://admin-shell.io/aas/3/2/EventPayload/payload`
...
h|ID: 3+| `\https://admin-shell.io/aas/3/2/Blob`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|[[Blob-value]]value  3+| `\https://admin-shell.io/aas/3/2/Blob/value`
a|
...
.2+e|[[Blob-contentType]]contentType  3+| `\https://admin-shell.io/aas/3/2/Blob/contentType`
a|
...
h|ID: 3+| `\https://admin-shell.io/aas/3/2/Capability`
...
A data element is a SubmodelElement that is not further composed of other SubmodelElements.

A data element is a SubmodelElement that has a value or a predefined number of values like range data elements.
...
A data element is a SubmodelElement that has a value.
The type of value differs for different subtypes of data elements.
...
h|ID: 3+| `\https://admin-shell.io/aas/3/2/DataElement`
...
The entity SubmodelElement is designed to be used in submodels defining the relationship between the parts of the composite asset it is composed of (e.g. bill of material).
...
h|Inherits from: 3+|
h|ID: 3+| `\https://admin-shell.io/aas/3/2/Entity`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|[[Entity-statements]]statement 3+| `\https://admin-shell.io/aas/3/2/Entity/statement`
a| Statement applicable to the entity, each statement described by SubmodelElement - typically with a qualified value |xref:spec-metamodel/core.adoc#SubmodelElement[SubmodelElement] |0..*

.2+e|[[Entity-entityType]]entityType 3+| `\https://admin-shell.io/aas/3/2/Entity/entityType`
a|Describes whether the entity is a co-managed entity or a self-managed entity |xref:EntityType[EntityType]|0..1

.2+e|[[Entity-globalAssetId]]globalAssetId 3+| `\https://admin-shell.io/aas/3/2/Entity/globalAssetId`
a|Global identifier of the asset the entity is representing |xref:spec-metamodel/datatypes.adoc#Identifier[Identifier] |0..1

.2+e|[[Entity-specificAssetIds]]specificAssetId 3+| `\https://admin-shell.io/aas/3/2/Entity/specificAssetId`
...
|Set of: |--
h|ID: | `\https://admin-shell.io/aas/3/2/EntityType`

.2+h|Literal h| ID
h|Explanation

.2+e|[[EntityType-CoManagedEntity]]CoManagedEntity | `\https://admin-shell.io/aas/3/2/EntityType/CoManagedEntity`
a|
...
.2+e|[[EntityType-SelfManagedEntity]]SelfManagedEntity | `\https://admin-shell.io/aas/3/2/EntityType/SelfManagedEntity`
a|
...
h|Inherits from: 3+|xref:spec-metamodel/core.adoc#SubmodelElement[SubmodelElement]
h|ID: 3+| `\https://admin-shell.io/aas/3/2/EventElement`
...
.Metamodel of File SubmodelElement
...
h|Inherits from: 3+|xref:DataElement[DataElement]
h|ID: 3+| `\https://admin-shell.io/aas/3/2/File`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|value 3+| `\https://admin-shell.io/aas/3/2/File/value`
a|
...
.2+e|contentType 3+| `\https://admin-shell.io/aas/3/2/File/contentType`
a|Content type of the content of the file 

|xref:spec-metamodel/datatypes.adoc#ContentType[ContentType] |0..1

.2+e|fingerprint 3+| `\https://admin-shell.io/aas/3/3/File/fingerprint`
a| 
Fingerprint calculated over the content of the linked file

|xref:spec-metamodel/datatypes.adoc#FingerprintType[FingerprintType] |0..*
...
h|Inherits from: 3+|xref:DataElement[DataElement]
h|ID: 3+| `\https://admin-shell.io/aas/3/2/MultiLanguageProperty`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|value 3+| `\https://admin-shell.io/aas/3/2/MultiLanguageProperty/value`
a|The value of the property instance |xref:spec-metamodel/datatypes.adoc#MultiLanguageTextType[MultiLanguageTextType] |0..1

.2+e|valueId 3+| `\https://admin-shell.io/aas/3/2/MultiLanguageProperty/valueId`
a|
...
h|Inherits from: 3+|xref:spec-metamodel/core.adoc#SubmodelElement[SubmodelElement]
h|ID: 3+| `\https://admin-shell.io/aas/3/2/Operation`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|inputVariable 3+| `\https://admin-shell.io/aas/3/2/Operation/inputVariable`
a|Input parameter of the operation |xref:OperationVariable[OperationVariable] |0..*

.2+e|outputVariable 3+| `\https://admin-shell.io/aas/3/2/Operation/outputVariable`
a|Output parameter of the operation |xref:OperationVariable[OperationVariable] |0..*

.2+e|inoutputVariable 3+| `\https://admin-shell.io/aas/3/2/Operation/inoutputVariable`
...
h|Explanation: 3+a|The value of an operation variable is a SubmodelElement that is used as input and/or output variable of an operation.
h|Inherits from: 3+|--
h|ID: 3+| `\https://admin-shell.io/aas/3/2/OperationVariable`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|value 3+| `\https://admin-shell.io/aas/3/2/OperationVariable/value`
a|Describes an argument or result of an operation via a SubmodelElement |xref:spec-metamodel/core.adoc#SubmodelElement[SubmodelElement] |1
|===

Specification of operations in Submodel with xref:spec-metamodel/common.adoc#HasKind[kind]=xref:spec-metamodel/common.adoc#ModellingKind[Instance] are handled identical to operations in Submodel Templates (Submodel with xref:spec-metamodel/common.adoc#HasKind[kind]=xref:spec-metamodel/common.adoc#ModellingKind[Template])

====
Note 1: an operation can  be invoked via an API call (_InvokeOperationSync_ and _InvokeOperationAsync_). For further explanation see Part 2 (IDTA-01002).
====

====
Note 2: _OperationVariable_ is introduced as separate class to enable future extensions, e.g. for adding a default value or cardinality (optional/mandatory).
====
...
h|Inherits from: 3+|xref:DataElement[DataElement]
h|ID: 3+| `\https://admin-shell.io/aas/3/2/Property`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|valueType 3+| `\https://admin-shell.io/aas/3/2/Property/valueType`
a|Data type of the value attribute |xref:spec-metamodel/datatypes.adoc#DataTypeDefXsd[DataTypeDefXsd] |1

.2+e|value 3+| `\https://admin-shell.io/aas/3/2/Property/value`
a|The value of the property instance |xref:spec-metamodel/datatypes.adoc#ValueDataType[ValueDataType] |0..1

.2+e|valueId 3+| `\https://admin-shell.io/aas/3/2/Property/valueId`
...
h|Inherits from: 3+|xref:DataElement[DataElement]
h|ID: 3+| `\https://admin-shell.io/aas/3/2/ReferenceElement`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|value  3+| `\https://admin-shell.io/aas/3/2/ReferenceElement/value`
...
The semantics of the relationship is defined via the _semanticId_ of the _RelationshipElement_.
If this semantic definition requires additional information not contained in the _first_ or _second_ object referenced via the relationship, the SubmodelElement type xref:spec-metamodel/submodel-elements.adoc#annotated-relationship-element-attributes[AnnotatedRelationshipElement] shall be used instead.
...
h|Inherits from: 3+|xref:spec-metamodel/core.adoc#SubmodelElement[SubmodelElement]
h|ID: 3+| `\https://admin-shell.io/aas/3/2/RelationshipElement`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|first 3+| `\https://admin-shell.io/aas/3/2/RelationshipElement/first`
...
.2+e|second 3+| `\https://admin-shell.io/aas/3/2/RelationshipElement/second`
...
== SubmodelElement Collection Attributes

.Metamodel of SubmodelElement Collections
...
SubmodelElement Collections are used for complex elements with a typically fixed set of properties with unique names.
This set of properties is typically predefined by the semantic definition (referenced via xref:spec-metamodel/common.adoc#HasSemantics[semanticId]) of the SubmodelElement collection.
Each property within the collection itself should have clearly defined semantics.

====
Note: the different elements of a SubmodelElement collection do not have to have different xref:spec-metamodel/common.adoc#HasSemantics[semanticIds].
...
====
Note: the elements within a SubmodelElement collection are not ordered.
...
h|Explanation: 3+a|A SubmodelElement collection is a kind of struct, i.e. a logical encapsulation of multiple named values.
h|Inherits from: 3+|
h|ID: 3+| `\https://admin-shell.io/aas/3/2/SubmodelElementCollection`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|value 3+| `\https://admin-shell.io/aas/3/2/SubmodelElementCollection/value`
|SubmodelElement contained in the collection |xref:spec-metamodel/core.adoc#SubmodelElement[SubmodelElement] |0..*
|===

[#submodel-element-list-attributes]
== SubmodelElement List Attributes

.Metamodel of SubmodelElement Lists
...
SubmodelElement lists are used for sets (i.e. unordered collections without duplicates), ordered lists (i.e. ordered collections that may contain duplicates), bags (i.e. unordered collections that may contain duplicates), and ordered sets (i.e. ordered collections without duplicates).


SubmodelElement lists are also used to create multidimensional arrays.
A two-dimensional array _list[3][5]_ with _Property_ values would be realized like follows: the first SubmodelElement list would contain three xref:spec-metamodel/submodel-elements.adoc#submodel-element-list-attributes[SubmodelElementList] elements.
...
h|Explanation: 3+a|
A SubmodelElement list is an ordered list of SubmodelElements.
...
h|Inherits from: 3+|
h|ID: 3+| `\https://admin-shell.io/aas/3/2/SubmodelElementList`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|orderRelevant 3+| `\https://admin-shell.io/aas/3/2/SubmodelElementList/orderRelevant`
a|
...
.2+e|value 3+| `\https://admin-shell.io/aas/3/2/SubmodelElementList/value`
a|SubmodelElement contained in the list |xref:spec-metamodel/core.adoc#SubmodelElement[SubmodelElement] |0..*

.2+e|semanticIdListElement 3+| `\https://admin-shell.io/aas/3/2/SubmodelElementList/semanticIdListElement`
a|
Semantic ID which the SubmodelElements contained in the list match
...
.2+e|typeValueListElement  3+| `\https://admin-shell.io/aas/3/2/SubmodelElementList/typeValueListElement/typeValueListElement`
a|The SubmodelElement type of the SubmodelElements contained in the list |xref:spec-metamodel/referencing.adoc#AasSubmodelElements[AasSubmodelElements]|1

.2+e|valueTypeListElement 3+| `\https://admin-shell.io/aas/3/2/SubmodelElementList/valueTypeListElement`
a|The value type of the SubmodelElement contained in the list |xref:spec-metamodel/datatypes.adoc#DataTypeDefXsd[DataTypeDefXsd]|0..1
|===
...
h|Explanation: a|Enumeration of SubmodelElement types including abstract SubmodelElement types
...
h|ID: | `\https://admin-shell.io/aas/3/2/AasSubmodelElements`

.2+h|Literal h| ID
h|Explanation


.2+e|AnnotatedRelationshipElement | `\https://admin-shell.io/aas/3/2/AasSubmodelElements/AnnotatedRelationshipElement`
a|Annotated relationship element


.2+e|BasicEventElement | `\https://admin-shell.io/aas/3/2/AasSubmodelElements/BasicEventElement`
a|Basic event element

.2+e|Blob | `\https://admin-shell.io/aas/3/2/AasSubmodelElements/Blob`
a|Blob

.2+e|Capability | `\https://admin-shell.io/aas/3/2/AasSubmodelElements/Capability`
a|Capability

.2+e|DataElement | `\https://admin-shell.io/aas/3/2/AasSubmodelElements/DataElement`
a|
Data Element
...
.2+e|Entity | `\https://admin-shell.io/aas/3/2/AasSubmodelElements/Entity`
a|Entity

.2+e|EventElement | `\https://admin-shell.io/aas/3/2/AasSubmodelElements/EventElement`
a|
Event
...
.2+e|File | `\https://admin-shell.io/aas/3/2/AasSubmodelElements/File`
a|File


.2+e|MultiLanguageProperty | `\https://admin-shell.io/aas/3/2/AasSubmodelElements/MultiLanguageProperty`
a|Property with a value that can be provided in multiple languages

.2+e|Operation| `\https://admin-shell.io/aas/3/2/AasSubmodelElements/Operation`
a|Operation

.2+e|Property | `\https://admin-shell.io/aas/3/2/AasSubmodelElements/Property`
a|Property

.2+e|Range | `\https://admin-shell.io/aas/3/2/AasSubmodelElements/Range`
a|Range with min and max



.2+e|ReferenceElement | `\https://admin-shell.io/aas/3/2/AasSubmodelElements/ReferenceElement`
a|Reference

.2+e|RelationshipElement | `\https://admin-shell.io/aas/3/2/AasSubmodelElements/RelationshipElement`
a|Relationship


.2+e|SubmodelElement | `\https://admin-shell.io/aas/3/2/AasSubmodelElements/SubmodelElement`
a|
SubmodelElement


====
Note: SubmodelElements are abstract, i.e. if a key uses "SubmodelElement", the reference may be a property, a SubmodelElement list, an operation, etc.
====


.2+e|SubmodelElementCollection | `\https://admin-shell.io/aas/3/2/AasSubmodelElements/SubmodelElementCollection`
a|Struct of SubmodelElements

.2+e|SubmodelElementList | `\https://admin-shell.io/aas/3/2/AasSubmodelElements/SubmodelElementList`
