...
A data element is a SubmodelElement that is not further composed of other Submodel elements.
...
h|Explanation: 3+a|
A SubmodelElement list is an ordered list of Submodel elements.
...
a|The SubmodelElement type of the Submodel elements contained in the list |xref:spec-metamodel/referencing.adoc#AasSubmodelElements[AasSubmodelElements]|1
