...
If the Submodel is of _kind=Template_ (modelling kind as inherited by _HasKind_), the Submodel elements within the Submodel are presenting SubmodelElement templates.
If the Submodel is of _kind=Instance_, its Submodel elements represent SubmodelElement instances.
