...
h|ID: 3+| `\https://admin-shell.io/aas/3/2/AssetAdministrationShell`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|derivedFrom 3+| `\https://admin-shell.io/aas/3/2/AssetAdministrationShell/derivedFrom`
...
.2+e|assetInformation 3+| `\https://admin-shell.io/aas/3/2/AssetAdministrationShell/assetInformation`
...
.2+e|submodel 3+| `\https://admin-shell.io/aas/3/2/AssetAdministrationShell/submodel`
a|
...
h|Inherits from: 3+|--
h|ID: 3+| `\https://admin-shell.io/aas/3/2/AssetInformation`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|[[assetKind]]assetKind  3+| `\https://admin-shell.io/aas/3/2/AssetInformation/assetKind`
...
.2+e|[[globalAssetId]]globalAssetId 3+| `\https://admin-shell.io/aas/3/2/AssetInformation/globalAssetId`
a|
...
.2+e|[[specificAssetId]]specificAssetId 3+| `\https://admin-shell.io/aas/3/2/AssetInformation/specificAssetId`
...
.2+e|[[assetType]]assetType 3+| `\https://admin-shell.io/aas/3/2/AssetInformation/assetType`
a|
...
.2+e|[[defaultThumbnail]]defaultThumbnail 3+| `\https://admin-shell.io/aas/3/2/AssetInformation/defaultThumbnail`
...
h|Inherits from: 3+|--
h|ID: 3+| `\https://admin-shell.io/aas/3/2/Resource`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|path 3+| `\https://admin-shell.io/aas/3/2/Resource/path`
a|
...
.2+e|contentType 3+| `\https://admin-shell.io/aas/3/2/Resource/contentType`
a|
...
h|Set of: |--
h|ID: | `\https://admin-shell.io/aas/3/2/AssetKind`

.2+h|Literal h| ID
h|Explanation

.2+e|Type | `\https://admin-shell.io/aas/3/2/AssetKind/Type`
a|Type asset

.2+e|Instance | `\https://admin-shell.io/aas/3/2/AssetKind/Instance`
a|Instance asset

.2+e|Batch | `\https://admin-shell.io/aas/3/2/AssetKind/Batch`
a|batch asset

.2+e|Role | `\https://admin-shell.io/aas/3/2/AssetKind/Role`
a|Role asset

.2+e|NotApplicable | `\https://admin-shell.io/aas/3/2/AssetKind/NotApplicable`
a|None of the other asset kinds
...
h|ID: 3+| `\https://admin-shell.io/aas/3/2/SpecificAssetId`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|name 3+| `\https://admin-shell.io/aas/3/2/SpecificAssetId/name`
a|Name of the asset identifier |xref:spec-metamodel/datatypes.adoc#LabelType[LabelType] |1

.2+e|value 3+| `\https://admin-shell.io/aas/3/2/SpecificAssetId/value`
...
.2+e|externalSubjectId 3+| `\https://admin-shell.io/aas/3/2/SpecificAssetId/externalSubjectId`
a|
...
If the Submodel is of _kind=Template_ (modelling kind as inherited by _HasKind_), the SubmodelElements within the Submodel are presenting SubmodelElement templates.
If the Submodel is of _kind=Instance_, its SubmodelElements represent SubmodelElement instances.
...
h|ID: 3+| `\https://admin-shell.io/aas/3/2/Submodel`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|submodelElement 3+| `\https://admin-shell.io/aas/3/2/Submodel/submodelElement`
a|SubmodelElement contained in the Submodel |xref:SubmodelElement[SubmodelElement] |0..*
|===

[#submodel-element-attributes]
== SubmodelElement Attributes

.Metamodel of SubmodelElement
...
SubmodelElements are qualifiable elements, i.e. one or more qualifiers may be defined for each of them.

It is recommended to add a xref:spec-metamodel/common.adoc#HasSemantics[HasSemantics/semanticId] to a _SubmodelElement_.

SubmodelElements may also have defined data specification templates.
...
h|Explanation: 3+a|A SubmodelElement is an element suitable for the description and differentiation of assets.
...
h|ID: 3+| `\https://admin-shell.io/aas/3/2/SubmodelElement`
