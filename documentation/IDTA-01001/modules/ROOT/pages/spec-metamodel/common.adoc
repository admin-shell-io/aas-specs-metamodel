...
.2+e|supplementalSemanticId 3+| `\https://admin-shell.io/aas/3/2/HasSemantics/supplementalSemanticId`
a|
...
Examples: a Submodel is the name space for the properties directly contained in it; the name space of a SubmodelElement contained in a SubmodelElement collection is the SubmodelElement collection.
