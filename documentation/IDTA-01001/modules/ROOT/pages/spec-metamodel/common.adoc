...
.2+e|[[createdAt]]createdAt 3+| `\https://admin-shell.io/aas/3/1/AdministrativeInformation/createdAt`
a| date of creation | xref:spec-metamodel/datatypes.adoc#DateTimeUtc[DateTimeUtc] |0..1

.2+e|[[updatedAt]]updatedAt 3+| `\https://admin-shell.io/aas/3/1/AdministrativeInformation/updatedAt`
