...
In principle, a version corresponds to the _version_identifier_ according to IEC 62832.
However, it is not used for concept identifiers only (IEC TS 62832-1), but for all identifiable elements.
Together, <<version>>, <<revision>> and <<patch>> correspond to the version number according to IEC 62832.
...
For more information on the concept of subject as used to describe the <<creator>>, see Attribute Based Access Control (ABAC) xref:bibliography.adoc#bib49[[49\]].
...
a) xref:spec-metamodel/common.adoc#version[version]   (xref:spec-metamodel/common.adoc#revision[revision] and xref:spec-metamodel/common.adoc#patch[patch] are ignored) 
...
====
Note 4: Up to now xref:spec-metamodel/common.adoc#templateId[AdministrativeInformation/templateId]  is only applicable for Submodels since Template Specifications are standardized for Submodels only.
====

To ensure reliable sorting and enable logical comparisons, the <<version>>, <<revision>> and <<patch>> attributes are stored as numerical integer types rather than as text strings. 
This design prevents common sorting errors (e.g., a text-based sort incorrectly placing "V1.10.0" before "V1.2.0") and allows the system to mathematically determine which release is newer.
...
V1.0.0 < V1.1.1 < V2.0.0

The date attribute <<createdAt>> is bound to the identity of the object itself, not to its individual version states. 
This means that while an object's <<version>>, <<revision>> and <<patch>> will increment over time, its _createdAt_ timestamp remains fixed to the moment the object was first created.
...
For example, the _updatedAt_ timestamp of V2.0.0 will be later than the _updatedAt_ timestamp of V1.1.0.
...
====
Note 5: It is important to clarify that not every change to an object's data will necessarily trigger a new release (update of <<version>>, <<revision>> or <<patch>> attributes) or an update to the <<updatedAt>> timestamp. 
The <<version>>, <<revision>>, <<patch>>, <<createdAt>>, and <<updatedAt>> attributes should be treated as business values, not technical system values. 
...
h|ID: 3+| `\https://admin-shell.io/aas/3/2/AdministrativeInformation`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|[[version]]version 3+| `\https://admin-shell.io/aas/3/2/AdministrativeInformation/version`
|Version of the element |xref:spec-metamodel/datatypes.adoc#VersionType[VersionType] |0..1

.2+e|[[revision]]revision 3+| `\https://admin-shell.io/aas/3/2/AdministrativeInformation/revision`
|Revision of the element |xref:spec-metamodel/datatypes.adoc#RevisionType[RevisionType] |0..1

.2+e|[[patch]]patch 3+| `\https://admin-shell.io/aas/3/2/AdministrativeInformation/patch`
|Patch of the element |xref:spec-metamodel/datatypes.adoc#PatchType[PatchType] |0..1

.2+e|[[creator]]creator 3+| `\https://admin-shell.io/aas/3/2/AdministrativeInformation/creator`
...
.2+e|[[createdAt]]createdAt 3+| `\https://admin-shell.io/aas/3/2/AdministrativeInformation/createdAt`
a| date of creation | xref:spec-metamodel/datatypes.adoc#DateTimeUtc[DateTimeUtc] |0..1

.2+e|[[updatedAt]]updatedAt 3+| `\https://admin-shell.io/aas/3/2/AdministrativeInformation/updatedAt`
a| date of update | xref:spec-metamodel/datatypes.adoc#DateTimeUtc[DateTimeUtc] |0..1

.2+e|[[templateId]]templateId 3+| `\https://admin-shell.io/aas/3/2/AdministrativeInformation/templateId`
a|
...
h|Inherits from: 3+|--
h|ID: 3+| `\https://admin-shell.io/aas/3/2/HasDataSpecification`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|dataSpecification 3+| `\https://admin-shell.io/aas/3/2/HasDataSpecification/dataSpecification`
a|
...
h|Inherits from: 3+|--
h|ID: 3+| `\https://admin-shell.io/aas/3/2/HasExtensions`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|[[extension]]extension 3+| `\https://admin-shell.io/aas/3/2/HasExtensions/extension`
...
h|ID: 3+| `\https://admin-shell.io/aas/3/2/Extension`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|name 3+| `\https://admin-shell.io/aas/3/2/Extension/name`
a|Name of the extension |xref:spec-metamodel/datatypes.adoc#NameType[NameType] |1

.2+e|[[Extension_valueType]]valueType 3+| `\https://admin-shell.io/aas/3/2/Extension/valueType`
...
.2+e|value 3+| `\https://admin-shell.io/aas/3/2/Extension/value`
a|Value of the extension |xref:spec-metamodel/datatypes.adoc#ValueDataType[ValueDataType] |0..1

.2+e|refersTo 3+| `\https://admin-shell.io/aas/3/2/Extension/refersTo`
...
h|Inherits from: 3+|--
h|ID: 3+| `\https://admin-shell.io/aas/3/2/HasKind`
...
.2+e|[[Aas_kind]]kind 3+| `\https://admin-shell.io/aas/3/2/HasKind/kind`
...
|Set of: |--
h|ID: | `\https://admin-shell.io/aas/3/2/ModellingKind`

.2+h|Literal h| ID
h|Explanation

.2+e|[[SubmodelTemplate]]Template | `\https://admin-shell.io/aas/3/2/ModellingKind/Template`
...
.2+e|[[SubmodelInstance]]Instance | `\https://admin-shell.io/aas/3/2/ModellingKind/Instance`
...
h|Inherits from: 3+|--
h|ID: 3+| `\https://admin-shell.io/aas/3/2/HasSemantics`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|[[semanticId]]semanticId 3+| `\https://admin-shell.io/aas/3/2/HasSemantics/semanticId`
a|
...
.2+e|[[supplementalSemanticId]]supplementalSemanticId 3+| `\https://admin-shell.io/aas/3/2/HasSemantics/supplementalSemanticId`
a|
...
h|ID: 3+| `\https://admin-shell.io/aas/3/2/Identifiable`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|administration 3+| `\https://admin-shell.io/aas/3/2/Identifiable/administration`
a|
...
.2+e|id 3+| `\https://admin-shell.io/aas/3/2/Identifiable/id`
...
h|Inherits from: 3+|--
h|ID: 3+| `\https://admin-shell.io/aas/3/2/Qualifiable`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|[[qualifier]]qualifier 3+| `\https://admin-shell.io/aas/3/2/Qualifiable/qualifier`
...
There are standardized qualifiers defined in link:https://cdd.iec.ch/cdd/iec61360-7/iec61360-7.nsf/TreeFrameset?OpenFrameSet&ongletactif=1[IEC CDD, IEC61360-7, CAA002]
and link:https://cdd.iec.ch/cdd/iec61987/iec61987.nsf/TreeFrameset?OpenFrameSet&ongletactif=1[IEC CDD, IEC 619897, ABJ604].
...
h|Inherits from: 3+|xref:spec-metamodel/common.adoc#HasSemantics[HasSemantics]
h|ID: 3+| `\https://admin-shell.io/aas/3/2/Qualifier`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|kind \<<Invalidated>> 3+| `\https://admin-shell.io/aas/3/2/Qualifier/kind`
a|
...
.2+e|type 3+| `\https://admin-shell.io/aas/3/2/Qualifier/type`
...
[cols="30%h,70%"]
|===
|Enumeration: e|[[QualifierKind]]QualifierKind  \<<Invalidated>>
h|Explanation: a|Enumeration for kinds of qualifiers
|Set of: |--
h|ID: | `\https://admin-shell.io/aas/3/2/QualifierKind`

.2+h|Literal h| ID
h|Explanation

.2+e|ValueQualifier | `\https://admin-shell.io/aas/3/2/QualifierKind/ValueQualifier`
a|
...
.2+e|ConceptQualifier | `\https://admin-shell.io/aas/3/2/QualifierKind/ConceptQualifier`
...
.2+e|TemplateQualifier | `\https://admin-shell.io/aas/3/2/QualifierKind/TemplateQualifier`
a|
...
Example of a _TemplateQualifier:_ a SubmodelElement with qualifier value "mandatory" or "optional".
...
[Example]
====
Example: a Submodel is the name space for the properties directly contained in it; the name space of a SubmodelElement contained in a SubmodelElement collection is the SubmodelElement collection.
====
...
h|ID: 3+| `\https://admin-shell.io/aas/3/2/Referable`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|category \<<Deprecated>> 3+| `\https://admin-shell.io/aas/3/2/Referable/category`
a|
...
.2+e|[[idShort]]idShort 3+| `\https://admin-shell.io/aas/3/2/Referable/idShort`
a|
...
.2+e|[[displayName]]displayName 3+| `\https://admin-shell.io/aas/3/2/Referable/displayName`
...
.2+e|[[description]]description 3+| `\https://admin-shell.io/aas/3/2/Referable/description`
a|
