...
h|ID: 3+| `\https://admin-shell.io/aas/3/2/ConceptDescription`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|isCaseOf 3+| `\https://admin-shell.io/aas/3/2/ConceptDescription/isCaseOf`
a|
...
Different types of SubmodelElements require different attributes to describe their semantics.
