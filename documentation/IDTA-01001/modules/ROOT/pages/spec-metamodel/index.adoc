...
////
====
Note: an xmi representation of the UML model can be found in the repository "aas-specs" in the GitHub project admin-shell-io *xref:bibliography.adoc#bib51[[51\]]*: https://github.com/admin-shell-io/aas-specs-metamodel/tree/master/schemas/xmi
====
////
...
* xref:Spec/Metamodel_SubmodelElements.adoc[SubmodelElement Types]
