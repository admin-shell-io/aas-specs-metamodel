...
|xsd |https://www.w3.org/TR/xmlschema-2/#string[string] a|Character string (but not all Unicode character strings) |"Hello world", 
...
.2+e|[[BlobType]]BlobType 2+| `\https://admin-shell.io/aas/3/2/BlobType`
a|
_base64binary_
...
.2+e|[[ContentType]]ContentType 2+| `admin-shell.io/aas/3/2/ContentType`
a|
_string_ with max 128 and min 1 characters

Any content type as specified in link:https://datatracker.ietf.org/doc/html/rfc2046[RFC2046].

The content type should be registered by the Internet Assigned Numbers Authority (link:https://www.iana.org/assignments/media-types/media-types.xhtml[IANA]) as specified in link:https://datatracker.ietf.org/doc/html/rfc2048[RFC2048].
...
.2+e|[[DateTimeUtc]]DateTimeUtc 2+| `\https://admin-shell.io/aas/3/2/DateTimeUtc`
a| _dateTime_ for UTC a|

    1997-07-16T19:20+01:00

	2025-02-24T12:31:14Z

.2+e|[[FingerprintType]]FingerprintType 2+| `\https://admin-shell.io/aas/3/3/FingerprintType`
a| _string_ with max 128 and min 1 characters 

The content of the attribute shall start with an identifier for the used fingerprint followed by the fingerprint in Base64 encoding seperated by a `colon` :.
 
Supported fingerprint identifiers are `sha256`, `sha3-256`, and `sha3-51`.
...
.2+e|[[Identifier]]Identifier 2+| `\https://admin-shell.io/aas/3/2/Identifier`
a|_string_ with max 2048 and min 1 characters 

====
Note: For Identifier it is recommended to use existing standards, 
for example ID-Link (IEC 61406) may be used for the 
xref:spec-metamodel/core.adoc#AssetInformation[globalAssetId].  

Typically, identifier strings do not contain blanks, emoticons or carriage returns 
because they are not representable in existing systems.
====
...
.2+e|[[LabelType]]LabelType 2+| `\https://admin-shell.io/aas/3/2/LabelType`
a|_string_ with max 64 and min 1 characters a|"ABC1234"


.2+e|[[LangStringSet]]LangStringSet 2+| `\https://admin-shell.io/aas/3/2/LangStringSet`
a|
...
[source,rdf]
----
[] <https://admin-shell.io/aas/3/2/Referable/description> [
  rdf:type aas:LangStringTextType ;
  <https://admin-shell.io/aas/3/2/AbstractLangString/language> "en"^^xs:string ;
  <https://admin-shell.io/aas/3/2/AbstractLangString/text> "This is a multi-language value in English"^^xs:string ;
] ;
.
----
...
----
.2+e|[[MessageTopicType]]MessageTopicType 2+| `\https://admin-shell.io/aas/3/2/MessageTopicType`
a|_string_ with max 255 and min 1 characters |

.2+e|[[MultiLanguageNameType]]MultiLanguageNameType 2+| `\https://admin-shell.io/aas/3/2/MultiLanguageNameType`
...
.2+e|[[MultiLanguageTextType]]MultiLanguageTextType 2+| `\https://admin-shell.io/3/2/MultiLanguageTextType`
a| xref:LangStringSet[LangStringSet]
...
.2+e|[[NameType]]NameType 2+| `\https://admin-shell.io/aas/3/2/NameType`
a|_string_ with max 128 and min 1 characters |"ManufacturerPartId"

.2+e|[[PatchType]]PatchType 2+| `\https://admin-shell.io/aas/3/2/PatchType`
a|_string_ with max 4 and min 1 characters
...
.2+e|[[PathType]]PathType 2+| `\https://admin-shell.io/aas/3/2/PathType`
a|
...
.2+e|[[QualifierType]]QualifierType 2+| `\https://admin-shell.io/aas/3/2/QualifierType`
a|_NameType_ a|
"ExpressionSemantic" (as specified in DIN DKE SPEC 92000:2019-09, see xref:bibliography.adoc#bib16[[16\]])

"life cycle qual" (as specified in IEC 61360-7 - IEC/SC 3D - Common Data Dictionary



.2+e|[[RevisionType]]RevisionType 2+| `\https://admin-shell.io/aas/3/2/RevisionType`
a|
...
.2+e|[[ValueDataType]]ValueDataType 2+| `\https://admin-shell.io/aas/3/2/ValueDataType`
...
.2+e|[[VersionType]]VersionType 2+| `\https://admin-shell.io/aas/3/2/VersionType`
a|
_string_ with max 4 and min 1 characters
...
== Enumeration for SubmodelElement Value Types

Enumerations are primitive data types.
Most of the enumerations are defined in the context of their class.
This clause defines enumerations for SubmodelElement value typesfootnote:[E.g. Property/valueType].
...
.Data Types with Examples footnote:[See list of RDF-compatible XSD types with short description https://www.w3.org/TR/rdf11-concepts/#xsd-datatypes. Examples from https://eclipse-esmf.github.io/samm-specification/2.0.0/datatypes.html]
...
|Set of: |--
h|ID: | `\https://admin-shell.io/aas/3/2/DataTypeDefXsd`
...
|Set of: |--
h|ID: | `\https://admin-shell.io/aas/3/2/DataTypeDefRdf`
