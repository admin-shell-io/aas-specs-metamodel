...
h|Inherits from: 3+| --
h|ID: 3+| `\https://admin-shell.io/aas/3/2/Environment`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|assetAdministrationShell 3+| `\https://admin-shell.io/aas/3/2/Environment/assetAdministrationShell`
a|Asset Administration Shell |xref:spec-metamodel/core.adoc#AssetAdministrationShell[AssetAdministrationShell] |0..*

.2+e|submodel 3+| `\https://admin-shell.io/aas/3/2/Environment/submodel`
a|Submodel |xref:spec-metamodel/core.adoc#Submodel[Submodel] |0..*

.2+e|conceptDescription 3+| `\https://admin-shell.io/aas/3/2/Environment/conceptDescription`
