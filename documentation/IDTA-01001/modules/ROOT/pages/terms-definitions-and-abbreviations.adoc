...
implementation-independent potential of an Industrie 4.0 xref:terms-definitions-and-abbreviations.adoc#term-component[component]  to achieve an effect within a domain
