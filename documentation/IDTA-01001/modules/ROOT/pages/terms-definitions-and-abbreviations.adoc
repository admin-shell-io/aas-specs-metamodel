...
standardized xref:terms-definitions-and-abbreviations.adoc#term-digital-representation[digital representation] of an xref:terms-definitions-and-abbreviations.adoc#term-asset[asset]
...
implementation-independent potential of a xref:terms-definitions-and-abbreviations.adoc#term-component[component]  to achieve an effect within a domain
...
_[SOURCE: Glossary Industrie 4.0, removed "Industrie 4.0" from "Industrie 4.0 component" and minor changes]_
...
concrete, clearly identifiable xref:terms-definitions-and-abbreviations.adoc#term-component[component]  of a certain xref:terms-definitions-and-abbreviations.adoc#term-type[type]
...
defined characteristic suitable for the description and differentiation of products or xref:terms-definitions-and-abbreviations.adoc#term-component[components] 
...
well-defined element associated with a <<term-property,property>>  instance or xref:terms-definitions-and-abbreviations.adoc#term-submodel-element[SubmodelElement], restricting the value statement to a certain period of time or use case
