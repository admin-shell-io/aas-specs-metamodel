...
====
Note 6: the key type can be ignored since the fragment keys are always unique (e.g. all idShorts of Submodel elements in a Submodel or all Submodel elements in a SubmodelElement list or collection).
====
