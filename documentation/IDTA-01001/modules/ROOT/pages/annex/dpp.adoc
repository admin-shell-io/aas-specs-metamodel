...
In <<code-dppmetadata-two-regulations-json>> an example payload is given that covers two vertical regulations, in the example battery passport and vehicle passport.
As long as the unique product identifier remains the same a single instance of the DPP covers both regulations.

.Example DPPMetadata JSON Payload for two vertical regulations
[[code-dppmetadata-two-regulations-json]]
[source,json,linenums]
----
{
   "digitalProductPassportId": "https://www.example.org/dpp/1234545",
   ...
   "facilityId": "gxx:xxx987654",
   "contentSpecificationIds":[
      "https://admin-shell-io/idta/batterypassport/Nameplate/1",
      "https://admin-shell-io/idta/batterypassport/TechnicalData/1",
      "https://admin-shell-io/idta/batterypassport/HandoverDocumentation/2",
	  "https://admin-shell-io/idta/batterypassport/CarbonFootprint/1",
      "https://admin-shell-io/idta/batterypassport/ProductCondition/1",
      "https://admin-shell-io/idta/batterypassport/MaterialComposition/1",
      "https://admin-shell-io/idta/batterypassport/Circularity/1"
	  "https://admin-shell-io/idta/vehiclepassport/1",
...
| dppSchemaVersion | -- 	| a| In EN 18223:2026 no Schema is defined and thus there is also no defined schema version. However, the schema may be easily derived from the given JSON and XML examples.
