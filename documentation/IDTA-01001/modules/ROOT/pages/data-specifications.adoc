...
h|Inherits from: 3+|--
h|ID: 3+| `\https://admin-shell.io/aas/3/2/DataSpecification`

.2+h|Attribute 3+h| ID
h|Explanation h|Type h|Card.

.2+e|description 3+| `\https://admin-shell.io/aas/3/2/DataSpecification/description`
...
.2+e|administration 3+| `\https://admin-shell.io/aas/3/2/DataSpecification/administration`
a|
...
.2+e|id 3+| `\https://admin-shell.io/aas/3/2/DataSpecification/id`
a|
...
.2+e|dataSpecificationContent 3+| `\https://admin-shell.io/aas/3/2/DataSpecification/dataSpecificationContent`
...
h|Inherits from: 3+|--
h|ID: 3+| `\https://admin-shell.io/aas/3/2/DataSpecificationContent`
