...
This is an example for the request body when invoking an operation in "Normal" format:
...
This would be the payload as defined in the API specification for the invocation of an operation (link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01002/v3.2/specification/interfaces.html#InvokeOperationSync[InvokeOperationSync]) 
