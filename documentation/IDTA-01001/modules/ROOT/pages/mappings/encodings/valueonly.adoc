...
* A SubmodelElement is considered a leaf SubmodelElement if it does not contain other Submodel elements.
A leaf SubmodelElement follows the rules for the different Submodel elements considered in the serialization, as described below.
