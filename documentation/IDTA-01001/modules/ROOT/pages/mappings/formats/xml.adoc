...
For example, here is an XML snippet of an example SubmodelElements, where the first element is a
...
For example, the serialization for the metamodel `V3.2` lives in the namespace `https://admin-shell.io/aas/3/2`.
