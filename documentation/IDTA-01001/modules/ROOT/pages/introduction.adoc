...
File exchange (1) is described in detail in Part 5 of this document series (IDTA-01005).
...
The peer-to-peer interaction (3) is not (yet) specified. For first concepts on the I4.0 language see xref:bibliography.adoc#bib47[[47\]].
